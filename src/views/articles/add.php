...
<div class="m-3 col-md-6">
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="mb-3">
            ...
            <input type="text" id="inputName" name="name" class="form-control" value="<?= htmlspecialchars($_POST['name'] ?? '') ?>">
        </div>
        <div class="mb-3">
            <label for="inputText" class="form-label">Текст статьи</label>
            <textarea id="inputText" name="text" class="form-control"><?= htmlspecialchars($_POST['text'] ?? '') ?></textarea>
        </div>
        <div class="mb-3">
